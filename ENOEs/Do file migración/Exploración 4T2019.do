...
log using "/Users/sofiacorona/Desktop/Presentacion 24 feb.smcl", replace

use "/Users/sofiacorona/Desktop/Bases de Datos/ENOE/SDEMT419.dta"

****** 4T2019 ********
*exploracion de sdemt419

** Cambiar nombres de las variables a minúsculas.  Solo para 4T19 y 3T19

rename *, lower

***generar variable de lugar de nacimiento

* nacido en México = 0, nacido en Guatemala = 1, nacido en resto de America = 2, nacido en USA = 3, nacido en Europa = 4, nacido en Africa y Asia = 5 (siempre arrancar con missing para que no se introduzcan los missing en la categoría igual a cero)

generate lugar_nacimiento = .
replace lugar_nacimiento = 0 if l_nac_c <= 33
replace lugar_nacimiento = 1 if l_nac_c == 225
replace lugar_nacimiento = 2 if l_nac_c == 200
replace lugar_nacimiento = 3 if l_nac_c == 221
replace lugar_nacimiento = 4 if l_nac_c == 400  |  l_nac_c == 415
replace lugar_nacimiento = 5 if l_nac_c == 100  |  l_nac_c == 300 | l_nac_c == 500  |  l_nac_c == 600
...
generate latam = .
replace latam = 0 if lugar_nacimiento == 0 | lugar_nacimiento == 3 | lugar_nacimiento == 4 |lugar_nacimiento == 5
...
tab lugar_nacimiento [fweight = fac]
...
*exploracion de sdemt405

clear

cd "/Users/sofiacorona/Desktop/Bases de Datos"

use "/Users/sofiacorona/Desktop/Bases de Datos/ENOE/SDEMT405.dta"
...
replace lugar_nacimiento = 1 if l_nac_c == 225
replace lugar_nacimiento = 2 if l_nac_c == 200
replace lugar_nacimiento = 3 if l_nac_c == 221 |  l_nac_c == 201
replace lugar_nacimiento = 4 if l_nac_c == 400  |  l_nac_c == 415
replace lugar_nacimiento = 5 if l_nac_c == 100  |  l_nac_c == 300 | l_nac_c == 500  |  l_nac_c == 600
